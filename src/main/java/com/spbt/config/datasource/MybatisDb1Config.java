 ...
 */
@Configuration
@MapperScan(basePackages = MybatisDb1Config.SCAN_PACKAGE, sqlSessionFactoryRef = MybatisDb1Config.BEAN_SQL_SESSION_FACTORY_NAME)
public class MybatisDb1Config {

    /* 多数据原配置 - 修改开始 */
    public static final String SCAN_PACKAGE = "com.spbt.mapper.db1";
    public static final String MAPPER_LOCATION = "classpath*:mapper/db1/*.xml";
    static final String DATA_SOURCE_PROPERTIES_PREFIX = "spring.datasource.db1";
    static final String BEAN_NAME_PREFIX = "db1";
    static final String ENTITY_PACKAGE = "com.spbt.entity.db1";
    /* 多数据原配置 - 修改结束 */
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier(value = BEAN_DATA_SOURCE_NAME) DataSource dataSource) throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage(MybatisDb1Config.ENTITY_PACKAGE);
